...
Please click the relevant department or product below to learn more.
<br><br>
...
<div id="Utilities" class="tabcontent">
    <div class='row'> <!-- JACK -->
        <div class='colimg'>
            <img src='/images/products/paymentkiosk.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Point of Sale -->
        <div class='colimg'>
            <img src='/images/products/pos.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Gov On Track -->
        <div class='colimg'>
            <img src='/images/products/got.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Electronic Forms -->
        <div class='colimg'>
            <img src='/images/products/dice.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
...
<div id="Courts" class="tabcontent">
    <div class='row'> <!-- Citation Smart -->
        <div class='colimg'>
            <img src='/images/products/cs.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Online Dispute Resolution -->
        <div class='colimg'>
            <img src='/images/products/odr.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Remote Magistration -->
        <div class='colimg'>
            <img src='/images/products/cotg.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
...
<div id="Transportation" class="tabcontent">
    <div class='row'> <!-- GTAMS -->
        <div class='colimg'>
            <img src='/images/products/gtams.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Balance Express -->
        <div class='colimg'>
            <img src='/images/products/balanceexpress.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
...
<div id="Parking" class="tabcontent">
    <div class='row'> <!-- Parking Kiosks -->
        <div class='colimg'>
            <img src='/images/products/parkingkiosk.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
    ...
    <div class='row'> <!-- Mobile Payments -->
        <div class='colimg'>
            <img src='/images/products/parkingpayment.webp' width="80%" loading="lazy" class='smallimg'>
        </div>
        <div class='coltext'>
            <br>
...
<div id="jack" class="tabcontent" style="padding-left:30px; padding-bottom:30px;">
    ...
    <!-- <img src="https://i.imgur.com/FA7l0vF.jpg" width="80%" style="margin-left:100px; margin-right:100px; margin-bottom:40px; align:left;"/> -->
...
<div id="sms" class="tabcontent" style="padding-left:30px; padding-bottom:30px;">
    ...
    <div class="flexbox-container">
        <div class="flex-child">
            <!-- <img src="https://i.imgur.com/0gmWNtN.jpg" width="80%" style="margin-left:50px; margin-right:100px; margin-bottom:20px; align:left;"/> -->
        <h1>Benefits</h1>
